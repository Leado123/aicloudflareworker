...
export const AIBranchPrevious = ({
  ...
  return (
    <Button
      ...
      className={cn(
        "size-7 shrink-0 rounded-full text-neutral-500 transition-colors' dark:text-neutral-400",
...
export const AIBranchPage = ({ className }: AIBranchPageProps) => {
  ...
  return (
    <span
      className={cn(
        "font-medium text-neutral-500 text-xs tabular-nums' dark:text-neutral-400",
        className
      )}
    >
