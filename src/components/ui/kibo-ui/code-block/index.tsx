...
const lineNumberClassNames = cn(
  ...
  "[&_.line]:before:text-neutral-500/50' dark:'[&_.line]:before:text-neutral-400/50",
...
const codeBlockClassName = cn(
  "mt-0 bg-white text-sm' dark:bg-neutral-950",
  "[&_pre]:py-4",
...
export const CodeBlockHeader = ({
  ...
  <div
    className={cn(
      "flex flex-row items-center border-b bg-neutral-100 p-1' dark:bg-neutral-800",
      className
    )}
    {...props}
  />
...
export const CodeBlockFilename = ({
  ...
  return (
    <div
      className="flex items-center gap-2 bg-neutral-100 px-4 py-1.5 text-neutral-500 text-xs dark:bg-neutral-800 dark:text-neutral-400"
      {...props}
    >
...
export const CodeBlockSelectTrigger = ({
  ...
  <SelectTrigger
    className={cn(
      "w-fit border-none text-neutral-500 text-xs shadow-none' dark:text-neutral-400",
      className
    )}
    {...props}
  />
...
export const CodeBlockCopyButton = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <Icon size={14} className="text-neutral-500 dark:text-neutral-400" />}
    </Button>
  );
};
