    ...
    return (
        <div className="flex-1 h-full">
            ...
            <div className="flex flex-col md:flex-row h-full gap-2">
                {/* Calculator */}
                <div className="border rounded-lg h-1/2 w-full md:w-1/3 md:h-full md:min-w-[300px]">
                    <iframe 
                ...
                {/* Utilities */}
                <div className="border rounded-lg p-2 overflow-y-auto flex-1 md:h-full md:min-w-[400px]">
                    <ElementMolarMass/>
                    <iframe 
